% pn-tweak-libinput-touch-arbitration(SECTION) | User Commands
%
% "June  2 2023"
...
pn-tweak-libinput-touch-arbitration - program to do something

# SYNOPSIS

**pn-tweak-libinput-touch-arbitration** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pn-tweak-libinput-touch-arbitration** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pn-tweak-libinput-touch-arbitration** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pn-tweak-libinput-touch-arbitration** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pn-tweak-libinput-touch-arbitration. See **foo.conf**(5) for further details.
...
**pn-tweak-libinput-touch-arbitration** provides some return codes, that can be used in scripts:
