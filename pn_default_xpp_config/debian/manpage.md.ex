% pn-defaut-xpp-config(SECTION) | User Commands
%
% "June  6 2023"
...
pn-defaut-xpp-config - program to do something

# SYNOPSIS

**pn-defaut-xpp-config** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pn-defaut-xpp-config** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pn-defaut-xpp-config** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pn-defaut-xpp-config** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pn-defaut-xpp-config. See **foo.conf**(5) for further details.
...
**pn-defaut-xpp-config** provides some return codes, that can be used in scripts:
