% pn-default-gnome-config(SECTION) | User Commands
%
% "June  5 2023"
...
pn-default-gnome-config - program to do something

# SYNOPSIS

**pn-default-gnome-config** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pn-default-gnome-config** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pn-default-gnome-config** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pn-default-gnome-config** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pn-default-gnome-config. See **foo.conf**(5) for further details.
...
**pn-default-gnome-config** provides some return codes, that can be used in scripts:
