% pn-default-documents(SECTION) | User Commands
%
% "June  6 2023"
...
pn-default-documents - program to do something

# SYNOPSIS

**pn-default-documents** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pn-default-documents** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pn-default-documents** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pn-default-documents** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pn-default-documents. See **foo.conf**(5) for further details.
...
**pn-default-documents** provides some return codes, that can be used in scripts:
