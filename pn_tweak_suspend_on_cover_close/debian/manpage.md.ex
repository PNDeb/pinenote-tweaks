% pinenote-suspend-on-cover(SECTION) | User Commands
%
% "May 28 2023"
...
pinenote-suspend-on-cover - program to do something

# SYNOPSIS

**pinenote-suspend-on-cover** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pinenote-suspend-on-cover** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pinenote-suspend-on-cover** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pinenote-suspend-on-cover** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pinenote-suspend-on-cover. See **foo.conf**(5) for further details.
...
**pinenote-suspend-on-cover** provides some return codes, that can be used in scripts:
